...
public class Board : MonoBehaviour
{
    void Start()
    {
        ...
        Vector3 worldCenter = cam.ViewportToWorldPoint(CamCenter); // 카메라 중앙좌표를 월드좌표로 변환
        worldCenter.z = 0;
        ...
        for (int i = 0; i < numRows * numCols; i++)
        {
            ...
            go.GetComponent<Card>().Setting(arr[i], cardPosition.x, cardPosition.y); // 위치 정보를 Setting 함수에 전달
        }
